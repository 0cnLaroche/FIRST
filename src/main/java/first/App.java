...
public class App  extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		vb.getChildren().addAll(
				new ImageView(new Image( App.class.getResourceAsStream("/raccoon.png"))),
		...
		//Application icon
		stage.getIcons().add(new Image(App.class.getResourceAsStream("/raccoon.png")));
			...
			public void handle(ActionEvent event) {
				if (!adminMod.isAdmin()) {
					if(adminMod.showLoginDialog()) {
				        ImageView imageView = new ImageView(new Image(getClass().getResource("/unlock.png").toExternalForm(),
				                40, 40, false, true));
					...
					adminMod.logoff();
			        ImageView imageView = new ImageView(new Image(getClass().getResource("/lock.png").toExternalForm(),
			                40, 40, false, true));
			        btnLock.setGraphic(imageView);
		...
		String css = App.class.getResource("/bootstrap3.css").toExternalForm();
