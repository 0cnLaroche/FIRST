...
public class QueryModule extends FlowPane {

	public QueryModule() {
		
		// Queries Elements
				ObservableList<String> queryList = 
						FXCollections.observableArrayList("Networks by Approvers", "RUN codes"); // Add other queries here
				...
				this.getChildren().addAll(lvQueries,btnQuery);
